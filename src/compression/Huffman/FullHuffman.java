...
public class FullHuffman {
    ...
    public static void main(String[] params) {
        ...
        FullHuffman huf = new FullHuffman(orig);
        ...
        System.out.println("Length of decoded data in bits: " + orig2.length);
        System.out.println("Length of encoded data in bits: " + kood.length);
    }
